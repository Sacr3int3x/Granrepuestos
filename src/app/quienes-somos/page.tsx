          ...
          <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-4">
                GranRepuestos nació de la pasión por los automóviles y el deseo de ofrecer una solución honesta y confiable para la adquisición de repuestos. Lo que comenzó como un pequeño emprendimiento familiar ha crecido hasta convertirse en un referente en el mercado, siempre manteniendo nuestros valores fundamentales.
              </p>
